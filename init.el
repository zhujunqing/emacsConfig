...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (slime doom-themes doom-modeline help-find-org-mode org-pomodoro ace-window imenu-list go-mode scala-mode company monokai-theme hungry-delete swiper counsel smartparens js2-mode nodejs-repl exec-path-from-shell popwin web-mode dash smex reveal-in-osx-finder expand-region iedit helm-ag flycheck yasnippet auto-yasnippet winum evil use-package)))
